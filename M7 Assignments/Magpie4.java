...
public class Magpie4
{
    ...
    private String transformIWantToStatement(String statement)
    {
        ...
        String restOfStatement = statement.substring((position - 1) + 9).trim();
    ...
    {
        String[] responseBank = {"Interesting, tell me more.", "Hmmm.", "Do you really think so?", "You don't say.", "Wow, cool!", "Really!"};
        double r = Math.random();
        int whichResponse = (int)(r * responseBank.length);
        String response = responseBank[whichResponse];
        return response;
    }
}