...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if(statement.indexOf("Mr. Krupa") >= 0) {
            response = "He sounds like a fun teacher.";
        }
        else if(statement.trim().length() == 0) {
            response = "Please type in something.";
        }
        else if(statement.indexOf("car") >= 0) {
            response = "Tell me more about this car.";
        }
        else if(statement.indexOf("school") >= 0) {
            response = "Tell me more about your school.";
        }
        else if(statement.indexOf("town") >= 0) {
            response = "Tell me more about your town.";
        }
        else
        {
